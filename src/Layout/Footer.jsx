...
export default function Footer() {
    ...
    return (
        ...
        <footer className="p-8 bg-white rounded-lg shadow md:px-5 md:py-6 dark:bg-sky-500 static">
            <div className="sm:flex sm:items-center sm:justify-between">
                <a href="https://flowbite.com/" className="flex items-center mb-4 sm:mb-0">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white uppercase">Mr. Robot Security</span>
                </a>
                <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-white">
                    ...
                    <li>
                        <a href="#" className="mr-4 mt-5 hover:underline md:mr-6 ">Licensing</a>
                    </li>
                    <li>
