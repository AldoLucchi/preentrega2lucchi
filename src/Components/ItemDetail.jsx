            ...
            <div className="w-full max-w-sm bg-white  dark:bg-gray-800 dark:border-gray-700 ">
                ...
                <div className="px-5 pb-5 text-center">
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <span className="text-2xl font-bold text-gray-900 dark:text-white">Precio: </span> 
                        <span className="text-1xl text-gray-900 dark:text-white mr-10">{props.precio}</span> 
                    </div>
